...
**Ejercicio 2.1 (Visualizar un Histograma)** Sea `x3` el siguiente vector:
...
**Ejercicio 2.2 (Lanzar un par de Dados)** Vuelva a escribir la función `tirar` a continuación para lanzar un par de dados ponderados:
